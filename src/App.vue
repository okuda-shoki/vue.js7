...
<div id="app">
  ...
  <main>
    <div class="eyecatch">
      ...
      <div class="news-flex">
        <div class="news-left">
          <p class="news-data">2019/01/01</p>
            <p class="news-title">ニュースタイトルがここに入ります。三月の決算報告書</p>
            </div>
      ...
      <div class="mission">
        <div class="mission-content">
          <h2 class="mission-title">お客様のために成長企業であり続ける</h2>
          <p class="mission-text">顧客主導型サービスを提供する企業として、お客様の会社経営に必要なサービスと情報を提供し続ける企業支援会社を目指します。企業が現在直面している「勝ち残るため」の戦略を提供できる会社として、ホームページをはじめ、各種マーケティングをご提供いたします。</p>
      ...
      <div class="contact">
        ...
        <p class="contact-text">資料請求・お問い合わせなどなんでも気軽にお問い合わせください。お仕事のご連絡もお問い合わせページに飛んでいただいて、入力フォームにご記入お願いいたします。
        </p>
